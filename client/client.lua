...
-- Register exports for both the current resource name and 'bl_dialog'
exports('switchDialog', switchDialog)
exportHandler('bl_dialog', 'switchDialog', switchDialog)
...
exportHandler('bl_dialog', 'showDialog', showDialog)
